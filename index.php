...
<html>
  <head>
    ...
    <title>Boutique | E-commerce Website</title>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="pagesDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
                  <div class="dropdown-menu mt-3" aria-labelledby="pagesDropdown"><a class="dropdown-item border-0 transition-link" href="index.php">Homepage</a><a class="dropdown-item border-0 transition-link" href="shop.php?page=1">Category</a>
                  <a class="dropdown-item border-0 transition-link" href="cart.php">Shopping cart</a><a class="dropdown-item border-0 transition-link" href="checkout.php">Checkout</a></div>
                </li>
              </ul>
          ...
          <div class="container py-5">
            <div class="row px-4 px-lg-5">
              <div class="col-lg-6">
                ...
                <h1 class="h2 text-uppercase mb-3">20% off on new season</h1><a class="btn btn-dark" href="shop.php?page=1">Browse collections</a>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="row">
            <?php
              ...
              foreach($products as $product):
                ...
                // echo $ProductId;
                //select images
                $ImageQuery = "SELECT * FROM images WHERE product_id = $ProductId";
                $Image = $conn -> query($ImageQuery);
            ...
            <div class="col-4 mb-4 mb-md-0">
              <a class="category-item" href="shop.php?page=1">
                <img class="img-fluid" src="admin/uploads/<?= $AllImages[0] ?>" alt="">
                <strong class="category-item-title">
                  <!-- select category  -->
                  <?php
                  $catId = $product['cat_id'];
                  $CategoryQuery = "SELECT * FROM category WHERE id = $catId";
                  $category = $conn -> query($CategoryQuery);
              ...
              <div class="product text-center">
                <div class="position-relative mb-3">
                  ...
                  <a class="d-block" href="detail.php">
                    <img class="img-fluid w-100"  src="admin/uploads/<?= $AllImages[2] ?>" alt="...">
                  </a>
