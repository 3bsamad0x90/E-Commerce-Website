          ...
          <div class="row mb-5">
            <div class="col-lg-6">
              ...
              require_once('admin/functions/connect.php');
                $id = $_GET['id'];
                $QuerySelect = "SELECT * FROM images WHERE product_id = $id";
                $images = $conn -> query($QuerySelect);
                $images = $images -> fetch_assoc();
                $AllImages = explode(',', $images['img_name']);
              ?>  
              <div class="row m-sm-0">
                <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                  ...
                  <?php
                    ...
                    ?>
                    <div class="img-fluid owl-thumb-item flex-fill mb-3 mr-2 mr-sm-0">
                      <img class="w-100 mb-2" src="admin/uploads/<?= $image ?>" alt="...">
                    </div>
                ...
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="owl-carousel product-slider" data-slider-id="1">
                    <?php
                      foreach($AllImages as $image):
                    ?>
                    <a class="d-block" href="admin/uploads/<?= $image ?>" data-lightbox="product" title="Product item 1">
                      <img class="img-fluid" src="admin/uploads/<?= $image ?>" alt="...">
                    </a>
                    <!-- <a class="d-block" href="img/product-detail-2.jpg" data-lightbox="product" title="Product item 2">
                      <img class="img-fluid" src="img/product-detail-2.jpg" alt="...">
                    </a><a class="d-block" href="img/product-detail-3.jpg" data-lightbox="product" title="Product item 3">
                      <img class="img-fluid" src="img/product-detail-3.jpg" alt="...">
                    </a>
                    <a class="d-block" href="img/product-detail-4.jpg" data-lightbox="product" title="Product item 4">
                      <img class="img-fluid" src="img/product-detail-4.jpg" alt="...">
                    </a> -->
                    <?php
                    endforeach;
                    ?>
            ...
            <div class="col-lg-6">
              ...
              <!-- product name  -->
              <?php
                  $productSelect = "SELECT * FROM products WHERE id = $id";
                  $productDetails = $conn -> query($productSelect);
                  $productDetails = $productDetails -> fetch_assoc();
                  
              ?>
              <h1><?= $productDetails['name'] ?></h1>
              <p class="text-muted lead">$<?= $productDetails['price'] ?></p>
              <p class="text-small mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ut ullamcorper leo, eget euismod orci. Cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus. Vestibulum ultricies aliquam convallis.</p>
              <div class="row align-items-stretch mb-4">
