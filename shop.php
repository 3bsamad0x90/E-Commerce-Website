...
<html>
  <head>
    ...
    <title>Boutique | E-commerce bootstrap template</title>
          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.php"><span class="font-weight-bold text-uppercase text-dark">Boutique</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                  <!-- Link--><a class="nav-link active" href="shop.php?page=1">Shop</a>
                </li>
              ...
              <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                ...
                <div class="row">
                  ...
                  <?php
                    ...
                    $offsetNumber = ($pageNumber-1) * 3 ;
                    $productQuery = "SELECT * FROM products LIMIT 3 OFFSET $offsetNumber";
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        ...
                        <a class="d-block" href="detail.php?id=<?= $ProductId ?>">
                          <img class="img-fluid w-100" src="admin/uploads/<?= $AllImages[$count] ?>" alt="..."></a>
                ...
                <nav aria-label="Page navigation example">
                  <ul class="pagination justify-content-center justify-content-lg-end">
                    ...
                    ?>
                    <li class="page-item <?= ($page == $_GET['page']) ? 'active' : ''?>">
